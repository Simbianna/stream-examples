package future.f_g_example.flow;
...
public class SimpleCell implements Publisher<Integer>, Subscriber<Integer> {
    ...
    //оповещает подписчиков о новом значении
    ...
    public void onNext(Integer newValue) {
        value = newValue; //реагирует на новое значение ячейки, на которую подписан, обновляя свое значение
        System.out.println(name + ":" + value);
        notifyAllSubscribers(); //оповещает всех подписчиков о новом значении
    }
